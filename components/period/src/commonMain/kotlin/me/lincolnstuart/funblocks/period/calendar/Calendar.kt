package me.lincolnstuart.funblocks.period.calendar
...
import me.lincolnstuart.funblocks.core.text.utils.title.TitleSize
...
import me.lincolnstuart.funblocks.period.calendar.utils.MonthSnapshot
import me.lincolnstuart.funblocks.period.utils.ClickableArea
import me.lincolnstuart.funblocks.period.utils.Indicator
...
private fun RowScope.DayName(
    ...
    CalendarContent {
        Text(text = description, mode = TextMode.Title(size = TitleSize.H3))
    }
}
